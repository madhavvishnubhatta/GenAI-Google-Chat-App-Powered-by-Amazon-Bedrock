...
echo "This demo script deploys resources on AWS using Terraform. It includes resources and components that are needed to implement an AI-powered business assistant for Google Chat, leveraging the power of Amazon Bedrock."
...
#Add a terraform init and apply command for the code in the terraform folder using the variables from the user input
cd terraform
terraform init
terraform apply -var="knowledge_base_id=$kb_id" -var="llm_model=$llm" -var="region=us-east-1"
